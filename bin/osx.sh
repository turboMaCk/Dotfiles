...
# General: disbale the "Are you sure you want to open this application?" dialog
...
# General: disable smart quotes, they're annoying when typing code
defaults write NSGlobalDomain NSAutomaticQuoteSubstitutionEnabled -bool false

# General: disable smart dashes, they're annoying when typing code
...
defaults write NSGlobalDomain AppleLanguages -array "us" "cz"
defaults write NSGlobalDomain AppleLocale -string "cs_CZ@currency=EUR"
...
# Finder: enable window and Get Info animations
defaults write com.apple.finder DisableAllAnimations -bool false

# Set Home as the default location for new Finder windows
# For desktop paths, use `PfDe`
...
# General: disable .DS_Store files on network volumes
...
# Dock: disable automatically hide and show
