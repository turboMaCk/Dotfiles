...
#+BEGIN_SRC emacs-lisp :results none
  ;; pink comments
  ;;(set-face-foreground 'font-lock-comment-face "light pink") -- not with light theme
  ;; black bg behind current line
  ;;(set-face-background 'hl-line "#000000") not with white theme!
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :results none
  ...
  (custom-set-variables '(haskell-tags-on-save f))
