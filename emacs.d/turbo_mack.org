...
I'm using [[https://github.com/radian-software/straight.el][straight.el]] for managing my packages. Defining dependencies within ~init.el~
since I can't bother with ~use-package~ stuff.
...
** LSP recommended perfomrance settings
...
require dap's cpptools mode for debugging capabilities in Rust.

#+BEGIN_SRC elmacs-list
